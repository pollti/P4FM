...
wnd=[0.08000,0.08490,0.09950,0.12349,0.15636,0.19740,0.24575,0.30037,0.36009,0.42365,0.48969,0.55680,0.62355,0.68852,0.75033,0.80766,0.85927,0.90409,0.94114,0.96965,0.98899,0.99877,0.99877,0.98899,0.96965,0.94114,0.90409,0.85927,0.80766,0.75033,0.68852,0.62355,0.55680,0.48969,0.42365,0.36009,0.30037,0.24575,0.19740,0.15636,0.12349,0.09950,0.08490,0.08000]
% CAUTION: MANIPULATED: hamming(W);
...
for i=1:numberOfFrames
    ...
    D=Y(:,i)-(Delta(1:size(alpha)).*alpha.*N); %Nonlinear (Non-uniform) Power Specrum Subtraction
...
for i=1:FrameNum
    ...
    spec=Spec(:,i);
    var = real(ifft(spec,windowLen));
    if start+windowLen>=320
        disp('Hi');
    end
